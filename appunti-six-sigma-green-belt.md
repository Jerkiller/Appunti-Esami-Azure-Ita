...
* 9 Esame AIGPE 45/75 in no-time open-book

## Intro

### Cos'è qualità
* Deming - dal punto di vista cliente tutto quello k migliora la soddisfaz
* Duran - fitness for use
* ASQ - totalità catatteristiche per soddisfare bisogni (impliciti o espliciti)
* copc - fornisce soluz consistenti e accurate al primo tentativo
* ISO - livello di rispondere con caratteristiche ai requisiti
